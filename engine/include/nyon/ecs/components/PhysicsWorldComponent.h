...
namespace Nyon::ECS {
    struct PhysicsWorldComponent {
        ...
        float maxLinearCorrection = 1000.0f;         
        float maxAngularCorrection = 0.5f;           
        float maxPenetrationCorrection = 1000.0f;    
        ...
        struct Profile {
            ...
            float totalTime = 0.0f;                   } profile;
        struct Counters {
            int bodyCount = 0;                       
            int awakeBodyCount = 0;                  
            int contactCount = 0;                    
            int jointCount = 0;                      
            int islandCount = 0;                      } counters;
        ...
        struct Callbacks {
            ...
            std::function<void(uint32_t sensorId, uint32_t entityId)> sensorEnd; } callbacks;
