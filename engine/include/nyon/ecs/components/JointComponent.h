...
namespace Nyon::ECS {
    struct JointComponent {
        ...
        struct DistanceJointData {
            ...
            float dampingRatio = 0.0f;    } distanceJoint;
        struct RevoluteJointData {
            ...
            float referenceAngle = 0.0f;      } revoluteJoint;
        struct PrismaticJointData {
            ...
            float referenceAngle = 0.0f;      } prismaticJoint;
        struct WeldJointData {
            float referenceAngle = 0.0f;     
            float frequencyHz = 0.0f;        
            float dampingRatio = 0.0f;        } weldJoint;
